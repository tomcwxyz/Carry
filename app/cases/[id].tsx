...
const styles = StyleSheet.create({
  ...
  decisionText: { color: colours.ink, fontSize: 20, lineHeight: 27, fontWeight: '700' },
  ...
  blockTitle: { color: colours.ink, fontSize: 17, fontWeight: '700', marginBottom: spacing.md },
